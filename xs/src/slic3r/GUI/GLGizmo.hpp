...
//##############################################################################################################################################################
    Vec3d get_angles() const { return Vec3d(m_x.get_angle(), m_y.get_angle(), m_z.get_angle()); }
    void set_angles(const Vec3d& angles) { m_x.set_angle(angles(0)); m_y.set_angle(angles(1)); m_z.set_angle(angles(2)); }
//##############################################################################################################################################################
...
//##############################################################################################################################################################
    std::vector<Vec3d> m_instances_positions;
